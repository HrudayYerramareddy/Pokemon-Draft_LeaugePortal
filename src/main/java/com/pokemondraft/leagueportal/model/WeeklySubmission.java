...
public class WeeklySubmission {
  ...
  public WeeklySubmission(Long teamId, int week, String csv) {
    this.teamId = teamId;
    this.week = week;
    this.pokemonIdsCsv = csv;
  ...
  public String getPokemonIdsCsv() {
    return pokemonIdsCsv;
  }

  public void setPokemonIdsCsv(String v) {
    pokemonIdsCsv = v;
  }
