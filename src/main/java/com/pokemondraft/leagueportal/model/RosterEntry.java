...
public class RosterEntry {
    ...
    public RosterEntry(){}
    public RosterEntry(Long teamId,Long pokemonId){this.teamId=teamId;this.pokemonId=pokemonId;}
    public Long getId(){return id;} public Long getTeamId(){return teamId;} public void setTeamId(Long v){teamId=v;}
    public Long getPokemonId(){return pokemonId;} public void setPokemonId(Long v){pokemonId=v;}
}
